...
(function () {
    ...
    var ConditionalsBuilder = Garnish.Base.extend({
            ...
            refresh: function () {
                ...
                if (toggleFields.length === 0) {
                    this.disable();
                    this.$message.text(Craft.t('reasons', 'No toggle fields available.'));
                    return false;
                } else {
                    this.enable();
                    this.$message.text('');
                ...
                switch (toggleFieldType) {
                    ...
                    case 'craft\\fields\\Lightswitch':
                        ruleValueContent = this.templates.select([
                            { true: Craft.t('reasons', 'on') },
                            { false: Craft.t('reasons', 'off') }
                        ]);
                        break;
                    ...
                    case 'craft\\fields\\Users':
                        var options = [
                            {
                                'null': Craft.t('reasons', 'Empty').toLowerCase()
                            },
                            {
                                'notnull': Craft.t('reasons', 'Not empty').toLowerCase()
                            }
                        ];
                ...
                templates: {
                    ...
                    builderUi: function () {
                        return '<div class="reasonsBuilderUi">' +
                            '<div class="wrapper">' +
                            '<div class="heading"><span>' + Craft.t('reasons', 'Show this field if') + '</span></div>' +
                            '<div class="reasonsBuilder">' +
                            '<div class="reasonsStatement">' +
                            '<span class="delimiter">' + Craft.t('reasons', 'or') + '</span>' +
                            ...
                            '<select>' +
                            '<option value="==">' + Craft.t('reasons', 'is equal to') + '</option>' +
                            '<option value="!=">' + Craft.t('reasons', 'is not equal to') + '</option>' +
                            '</select>' +
                            '</div>' +
                            '<div class="reasonsRuleValue" />' +
                            '</div>' +
                            '<div class="reasonsRuleAmend">' +
                            '<a class="delete icon reasonsRemoveRule" title="' + Craft.t('reasons', 'Remove rule') + '"></a>' +
                            '<a class="add icon reasonsAddRule" title="' + Craft.t('reasons', 'and') + '"></a>' +
                            '</div>' +
                            '<span class="reasonsRuleLead">' + Craft.t('reasons', 'and') + '</span>' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                            '<div class="reasonsAdd">' +
                            '<a class="btn reasonsAddStatement">' + Craft.t('reasons', 'Add rules') + '</a>' +
                            '</div>' +
                            '</div>' +
    ...
    Craft.ReasonsPlugin.ConditionalsBuilder = ConditionalsBuilder;
